...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(135deg, hsl(185 75% 50%) 0%, hsl(195 80% 45%) 100%)',
      ...
      boxShadow: {
        'card': '0 4px 24px -4px hsl(185 75% 50% / 0.15)',
        'glow': '0 0 40px -10px hsl(185 75% 50% / 0.4)',
        'glow-sm': '0 0 20px -5px hsl(185 75% 50% / 0.3)',
      },
    },
  },
